...
#' @param ICs A list containing n vectors where n is the number of species. Each vector contains the value of each stage at t<=0. E.g. for 2 species with 1 and 2 stages respectively ICs could have the form: list(a,c(0,b)). Entries must be zero in all but the last stage unless the species has only one stage.
